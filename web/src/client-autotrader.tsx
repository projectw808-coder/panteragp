      ...
      {admin && (
        <div className="flex flex-wrap items-center gap-2 border-t border-pebble pt-3 text-xs dark:border-white/10">
          ...
          <p className="basis-full text-[11px] leading-relaxed text-slate-ink">
            Every client's bot is steered to {dflt}% unless a rate is set here for them: a trade ahead by a third of its risk is banked, a loser is held for the price
            to come back but never past half its risk, and cut early while the record sits above target. Real trades on real prices; only the timing is the desk's. Never shown to the client.
          </p>
        </div>
      )}
